var RedEsperanzaFirebase = (() => {
  ...
  // app/shared/firebase-client.js
  var firebase_client_exports = {};
  __export(firebase_client_exports, {
    createFirebaseClient: () => createFirebaseClient
  });
  ...
  function normalizeFirebaseConfig(config = {}) {
    ...
    const messagingSenderId = config.messagingSenderId || config.messaging_sender_id || (appId ? appId.split(":")[1] : void 0);
    return {
      projectId,
      databaseURL,
  ...
  function createFirebaseClient(config, handlers = {}) {
  ...
  return __toCommonJS(firebase_client_exports);
})();
